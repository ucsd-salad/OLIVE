...
Generate of the advice you would give, then follow the instructions below. 

Generate an Alloy predicate with the following rules.
...
def main():
    prompt = "there has been a geriatric fall and the patient can't recall if they hit their heads, and deny pain on palpationof their head/neck/spine,  do i immobilize and what's the immediate next step"
